<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Mastermain.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="AttendanceInAndOut.aspx.cs" Inherits="GroupHRIS.Attendance.AttendanceInAndOut" %>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtemployee" runat="server" ReadOnly="true" ClientIDMode="Static"
                            Width="150" Font-Bold="true" ForeColor="#009900" AutoPostBack="True" ></asp:TextBox>
                        <asp:image id="searchEmp" runat="server" alt="" src="../Images/Common/Search.jpg" height="20px" width="20px" onclick="openLOVWindow('../Employee/webFrmEmployeeSearch.aspx','search','txtemployee')" />
                        <%--<asp:Label ID="txtemployee" runat="server" Font-Bold="True" ForeColor="#009900"></asp:Label>--%>
                    </td><td><asp:Label ID="lblEmpName" runat="server" ></asp:Label></td>
                </tr>
                <tr>
                    <td style="text-align: right;">
                        Recommend By :
                ...
                <tr>
                    <td align="center" style="width: 100%">
                        <asp:GridView ID="gvAttendance" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                            PageSize="7" OnRowDataBound="gvAttendance_RowDataBound" 
