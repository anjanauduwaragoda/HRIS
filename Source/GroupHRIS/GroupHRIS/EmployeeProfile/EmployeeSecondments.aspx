<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmployeeSecondments.aspx.cs" Inherits="GroupHRIS.EmployeeProfile.EmployeeSecondments" %>
        ...
        <table class="ProfileMainTable">
            <tr>
                <td class="EmpProfilePhotoTD">
                    <asp:Label ID="Label1" runat="server" Font-Bold="True" ForeColor="#3366FF" Text="SECONDMENTS"
