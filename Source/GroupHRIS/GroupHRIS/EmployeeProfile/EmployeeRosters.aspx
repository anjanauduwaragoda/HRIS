<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmployeeRosters.aspx.cs"
    Inherits="GroupHRIS.EmployeeProfile.EmployeeRosters" %>
                ...
                <table class="ProfileMainTable">
                    <tr>
                        <td class="EmpProfilePhotoTD">
                            <asp:Label ID="Label1" runat="server" Font-Bold="True" ForeColor="#3366FF" Text="ROSTER DETAILS"
                ...
                <table class="ProfileMainTable">
                    <tr>
                        <td class="ProfileMainTableTDCenter" valign="top" colspan="4">
                            <asp:Label ID="l2" runat="server" BackColor="#00CC00" BorderWidth="1px" Height="20px"
                                Width="25px"></asp:Label>
                            &nbsp;<asp:Label ID="Label6" runat="server" Text=" Inter Chnage"></asp:Label>
                            &nbsp;<asp:Label ID="l3" runat="server" BackColor="#3366FF" BorderWidth="1px" Height="20px"
                                Width="25px"></asp:Label>
                            &nbsp;<asp:Label ID="Label7" runat="server" Text="Is Updated"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="ProfileMainTableTDCenter" valign="top">
                            <asp:Button ID="btnview" runat="server" OnClick="btnview_Click" Text="View Roster" />
                        </td>
                    </tr>
                    <tr>
                        <td class="ProfileMainTableTDCenter" valign="top" colspan="4">
