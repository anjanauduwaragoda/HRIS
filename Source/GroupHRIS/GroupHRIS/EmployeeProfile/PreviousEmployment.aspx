<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PreviousEmployment.aspx.cs" Inherits="GroupHRIS.EmployeeProfile.PreviousEmployment" %>
        ...
        <table class="ProfileMainTable">
            <tr>
                <td class="EmpProfilePhotoTD">
                    <asp:Label ID="Label1" runat="server" Font-Bold="True" ForeColor="#3366FF" Text="WORK EXPERIENCE"
        ...
        <table class="ProfileMainTable">
            ...
            <tr>
                ...
                <td class="ProfileMainTableTDLeft" valign="top" >
                    ...
                    <asp:Literal ID="LiteralSE2" runat="server"></asp:Literal>
