<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Mastermain.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="WebFrmRatingScheme.aspx.cs" Inherits="GroupHRIS.TrainingAndDevelopment.WebFrmRatingScheme" %>
        ...
        <ContentTemplate>
            ...
            <table>
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtName"
                            ErrorMessage="Rating Scheme name is required " ForeColor="Red" ValidationGroup="vgRatingScheme">*</asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td class="cell1">
                    ...
                    <td>
                        ...
                        <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtDescription"
                            ErrorMessage="Description is required " ForeColor="Red" ValidationGroup="vgProficiencyScheme">*</asp:RequiredFieldValidator>--%>
                    </td>
                </tr>
                <tr>
                    <td class="cell1">
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="ddlStatus"
                            ErrorMessage="Status is required" ForeColor="Red" ValidationGroup="vgRatingScheme">*</asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        Rating
                        <hr style="width: 550px;" align="left" />
                        <br />
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <table>
                            <tr>
                                ...
                                <td>
                                    <asp:RequiredFieldValidator ControlToValidate="txtRating" ID="rfvRating" runat="server"
                                        ErrorMessage="Rating is required" ValidationGroup="vgRatingLevels" ForeColor="Red">*</asp:RequiredFieldValidator>
                                </td>
                                <td class="style1">
                                ...
                                <td>
                                    <asp:RequiredFieldValidator ControlToValidate="ddlLevelStatus" ID="rfvStatus" runat="server"
                                        ErrorMessage="Status is required" ValidationGroup="vgRatingLevels" ForeColor="Red">*</asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            <tr>
                                ...
                                ValidationGroup="vgProficiencyLevels" ForeColor="Red">*</asp:RegularExpressionValidator>--%>
                                    <asp:FilteredTextBoxExtender ID="fteWeight" runat="server" FilterType="Numbers"
                                         TargetControlID="txtWeight">
                                    </asp:FilteredTextBoxExtender>
                                    <asp:RangeValidator ID="RangeValidator1"  ValidationGroup="vgRatingLevels" ControlToValidate="txtWeight" runat="server" ErrorMessage="Weight must be between 1 - 5" ForeColor="Red" Type="Integer" MaximumValue="5" MinimumValue="1">*</asp:RangeValidator>
                                    <asp:RequiredFieldValidator ControlToValidate="txtWeight" ID="rfvWeight" runat="server"
                                        ErrorMessage="Weight is required" ValidationGroup="vgRatingLevels" ForeColor="Red">*</asp:RequiredFieldValidator>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                <asp:RequiredFieldValidator ControlToValidate="txtLevelDescription" ID="RequiredFieldValidator3"
                                        runat="server" ErrorMessage="Description is required" ValidationGroup="vgRatingLevels"
                            ...
                            <tr align="left">
                                <td colspan="2" align="left">
                                    <asp:Button ID="btnRatingLevelSave" runat="server" Text="Add" Width="62px" ValidationGroup="vgRatingLevels"
                                        Style="height: 26px; float: left; margin-top: 16px;" OnClick="ratingLevel_btnSave_Click" />
                            ...
                            <tr>
                                <td colspan="4">
                                    ...
                                    <asp:ValidationSummary ID="ProficiencyLevelsSummery" DisplayMode="BulletList" ForeColor="Red"
                                        runat="server" ValidationGroup="vgRatingLevels" />
                                </td>
                            </tr>
                        </table>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <br />
                        <asp:GridView ID="gvRatingLevel" runat="server" Style="width: 530px;" AllowPaging="True"
                            OnPageIndexChanging="gvRatingLevel_PageIndexChanging" OnRowDataBound="gvRatingLevel_RowDataBound"
                            AutoGenerateColumns="False" OnSelectedIndexChanged="gvRatingLevel_SelectedIndexChanged">
                            <Columns>
                ...
                <tr>
                    ...
                    <td style="padding-left: 4px;">
                        <asp:Button ID="btnSave" runat="server" Text="Save" Width="125px" ValidationGroup="vgRatingScheme"
                ...
                <tr>
                    ...
                    <td class="style2">
                        ...
                        <asp:ValidationSummary ID="ValidationSummary1" runat="server" ValidationGroup="vgRatingScheme"
            ...
            <table width="100%">
                ...
                <tr>
                    <td colspan="2" align="center">
                        <asp:GridView ID="ratingSchemeGrid" runat="server" AllowPaging="True" OnPageIndexChanging="ratingSchemeGrid_PageIndexChanging"
                            OnRowDataBound="ratingSchemeGrid_RowDataBound" AutoGenerateColumns="False" OnSelectedIndexChanged="ratingSchemeGrid_SelectedIndexChanged">
                            <Columns>
                                <asp:BoundField DataField="RS_ID" HeaderText="Scheme Id" ItemStyle-CssClass="hiddencol"
                                    HeaderStyle-CssClass="hiddencol" />
                                <asp:BoundField DataField="RS_NAME" HeaderText="Scheme Name" />
                                <asp:BoundField DataField="DESCRIPTION" HeaderText="Description" />
                                <asp:BoundField DataField="STATUS_CODE" HeaderText="Status" />
                            </Columns>
                        </asp:GridView>
