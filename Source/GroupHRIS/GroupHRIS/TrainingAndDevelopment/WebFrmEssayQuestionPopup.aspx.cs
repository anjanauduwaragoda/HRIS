...
{
    public partial class WebFrmEssayQuestionPopup : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                fillNoOfAns();
                loadEssayQuestions(txtEvalId.Text);
                string programId = Request.QueryString["EvaluationId"];
            ...
            loadEsssayQuestionsWithEval(txtEvalId.Text);
        }
        ...
        public void loadEssayQuestions(string evalId)
        {
            EssayQuestionDataHandler EQDH = new EssayQuestionDataHandler();

            try
            {
                grdEssayQuestion.DataSource = EQDH.getAllQuestions(evalId);
