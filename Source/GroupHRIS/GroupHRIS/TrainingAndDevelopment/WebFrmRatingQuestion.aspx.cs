...
{
    public partial class WebFrmRatingQuestion : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (hfCaller.Value == "txtEvalId")
            {
                ...
                loadRatingQuestionsWithEval(hfVal.Value);
            }
        }
        ...
        public void loadRatingQuestions()
        {
            RatingQuestionDataHandler RQDH = new RatingQuestionDataHandler();
            log.Debug("loadRatingQuestions()");
            try
            {
                grdQuestion.DataSource = RQDH.getAllQuestions(txtEvalId.Text);
