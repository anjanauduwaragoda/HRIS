<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebFrmCEOGoalAssessment.aspx.cs"
    Inherits="GroupHRIS.PerformanceManagement.WebFrmCEOGoalAssessment" %>
...
<head runat="server">
    ...
    <title>CEO/COO Goal Assessment</title>
...
<body>
    ...
    <div class="Title">
        <span style="font-weight: 700">CEO/COO Goal Assessment Review</span>
    </div>
            ...
            <td colspan="4">
                <asp:GridView ID="grdvReportGrid" ClientIDMode="Static" Style="width: 100%;" AllowPaging="false"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="SUPERVISOR_SCORE" ItemStyle-VerticalAlign="Top" ItemStyle-Width="15%"
                            ItemStyle-HorizontalAlign="Right" HeaderText="Supervisor's Score %" />
                    </Columns>
                </asp:GridView>
            </td>
        </tr> 
