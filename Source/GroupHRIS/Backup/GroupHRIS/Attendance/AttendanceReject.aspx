<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AttendanceReject.aspx.cs" Inherits="GroupHRIS.Attendance.AttendanceReject" %>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:Button ID="btnExit" runat="server" Text="Exit"  
                                            Font-Size="Small" Height="30px" Width="100px" onclick="btnExit_Click"  />
                                    </td>
                                </tr>
                            </table>
                        </td>
