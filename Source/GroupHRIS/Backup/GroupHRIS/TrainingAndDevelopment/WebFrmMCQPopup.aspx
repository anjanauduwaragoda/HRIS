<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebFrmMCQPopup.aspx.cs" EnableEventValidation="false" Inherits="GroupHRIS.TrainingAndDevelopment.WebFrmMCQPopup" %>
...
<body class="popupsearch">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <hr />
            <table id="tblVisible" runat="server">
                <tr>
                    <td>
                        <table>
                            <tr>
            ...
            <table style="width: 100%;">
                <tr>
                    <td colspan="2" align="center" style="width: 100%;">
                        <asp:GridView ID="grdAnswer" runat="server" AutoGenerateColumns="false" Style="width: 340px;"
