...
{
    public partial class rptCadreAnalysisReport : System.Web.UI.Page
    {
        void loadReport(DataTable ReportDataSet1, DataTable ReportDataSet2, DataTable ReportDataSet3, DataTable ReportDataSet4, DataTable ReportDataSet5, Dictionary<string, string> ReportParameters, string reportDisplayName)
        {
            ...
            rptViewer.LocalReport.ReportPath = "Reports\\Reports\\rptCadreAnalysisReport.rdlc";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                try
                {
                    ...
                    loadReport(rptData1, rptData2, rptData3, rptData4, rptData5, rptParam, reportDisplayName);
                }
                catch (Exception exp)
                {
                    throw exp;
