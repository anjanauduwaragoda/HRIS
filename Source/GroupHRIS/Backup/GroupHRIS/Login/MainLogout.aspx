<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MainLogout.aspx.cs" Inherits="GroupHRIS.Login.MainLogout" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <link rel="shortcut icon" href="../Images/Common/logo.ico" />
    <title>EAP HRIS | LOGOUT</title>
...
<body id="MainLogOutBody" runat="server">
    ...
    <table class="MainBodyTB">
        <tr>
            <td class="styleTDMiddleGap" align="center">
                ...
                <br />
                <a href="MainLogin.aspx"><span id="blink" class="signinagainstyle">Click here to sign
                    in again</span></a>
            </td>
        </tr>
        <tr>
